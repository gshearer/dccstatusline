...
// with it. now is the wall clock in unix seconds, which the plan countdowns
// measure against; pass 0 when it is unavailable and they render empty.
void statusline_render(sbuf_t *, const payload_t *, const config_t *,
                       const gitinfo_t *, int64_t);
...
static sv_t fmt_clock(char *, size_t, int64_t, bool, bool);
static sv_t fmt_countdown(char *, size_t, int64_t, int64_t, bool);
...
static void sec_cwd(sbuf_t *, const payload_t *, const config_t *,
                    const gitinfo_t *);
static sv_t path_from_repo(sv_t, const gitinfo_t *);
...
static void sec_plan(sbuf_t *, const payload_t *, const config_t *,
                     plan_slot_t, section_id_t, int64_t);
static void render_section(sbuf_t *, section_id_t, const payload_t *,
                           const config_t *, const gitinfo_t *, int64_t);
#endif
